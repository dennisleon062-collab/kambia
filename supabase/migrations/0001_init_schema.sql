...
insert into cuentas (nombre, slug, tipo, moneda_codigo) values
  ('BCP Soles',            'bcp_pen',            'banco',           'PEN'),
  ('BCP Dólares',          'bcp_usd',            'banco',           'USD'),
  ('Scotiabank Soles',     'scotiabank_pen',     'banco',           'PEN'),
  ('Scotiabank Dólares',   'scotiabank_usd',     'banco',           'USD'),
  ('Interbank Soles',      'interbank_pen',      'banco',           'PEN'),
  ('Interbank Dólares',    'interbank_usd',      'banco',           'USD'),
  ('Conta Soles',          'conta_pen',          'banco',           'PEN'),
  ('Conta Dólares',        'conta_usd',          'banco',           'USD'),
